...
private:
	...
	// EQL: class is stored as a BITMASK dword (bit N = class N; multiclass = OR of bits) instead of
	// a plain id byte. When set, read the class as a dword and emit the lowest set-bit index (=primary
